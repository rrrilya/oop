...
void List::pop_back()
{
	...
	else { system("cls"); cout << "—писок пуст!\n\n"; }
}
void List::show_list()
{
	/*system("cls");*/
	...
	{
		int choice = 1;
		/*cout << "¬ведите 1 - вывод списка с начала\n¬ведите 2 - вывод списка с конца\n\n";
		cin >> choice;
		system("cls");*/
		switch (choice)
		{
...
void List::add_after(int number, int data)
{
	if (head != nullptr)
	{
		...
		else { system("cls"); cout << "ќшибка ввода!\n\n"; }
	}
	else { system("cls"); cout << "—писок пуст!\n\n"; }
}
